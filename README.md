...
This is an experimental implementation of [D4RT paper by Google](https://deepmind.google/blog/d4rt-teaching-ai-to-see-the-world-in-four-dimensions/).\
\
**What this thing do (in plain language):**\
Run the app, upload a video, some stuff will be done on it (the mayavius part), after completion you can interact with the video like you do in a video game. But it's all point-cloud. So it looks primitive.\
D4RT is primarily for AI models to give them spatial sense from videos.\
